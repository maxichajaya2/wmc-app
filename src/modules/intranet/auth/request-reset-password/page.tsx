    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-r from-[#00b3dc] via-[#0124e0] to-[#00023f] p-4">
      <div className="w-full max-w-md">
        <Card className="border-none shadow-xl">
          ...
          <CardContent>
            <div className="flex gap-2 items-start p-3 mt-2 rounded-md border border-cyan-200 bg-cyan-50 text-cyan-800">
              <AlertCircle className="h-5 w-5 shrink-0 text-cyan-600" />
              <p className="text-[12px] leading-tight">
                <strong className="block mb-0.5">Important:</strong>
                You must use the <b>same email address</b> you used during your
                abstract submission to ensure your profile and papers are linked
                correctly.
              </p>
            </div>
            <Form {...form}>
