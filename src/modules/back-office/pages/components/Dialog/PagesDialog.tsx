...
const FormSchema = z.object({
    ...
    urlKeyEn: z.string().min(3, {
        message: 'La url EN debe tener al menos 3 caracteres',
    }).max(255, {
        message: 'La url EN debe tener como máximo 255 caracteres',
    }),
    urlKeyEs: z.string().min(3, {
        message: 'La url ES debe tener al menos 3 caracteres',
    }).max(255, {
        message: 'La url ES debe tener como máximo 255 caracteres',
    }),
...
function RolesDialog() {
    ...
    const action = usePageStore(state => state.action);
    ...
    const closeActionModal = usePageStore(state => state.closeActionModal);
    const create = usePageStore(state => state.create);
    const update = usePageStore(state => state.update);
    const remove = usePageStore(state => state.remove);
    ...
    const form = useForm<z.infer<typeof FormSchema>>({
        ...
        defaultValues: {
            ...
            urlKeyEn: '',
            urlKeyEs: '',
            contentEn: selected?.contentEs || '',
            contentEs: selected?.contentEn || '',
            decriptionEn: '',
            decriptionEs: '',
        },
    })
                                ...
                                <Tabs defaultValue="spanish" className="w-full">
                                    ...
                                    <TabsContent value="spanish" className='flex flex-col gap-2'>
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="">
                                                    <FormLabel>Titulo Página (Español)</FormLabel>
                                                    <FormControl>
                                                        <Input
                                                            {...field}
                                                            type="text"
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="">
                                                    <FormLabel>Url Key (Español)</FormLabel>
                                                    <FormControl>
                                                        <Input
                                                            {...field}
                                                            type="text"
                                    ...
                                    <TabsContent value="english" className='flex flex-col gap-2'>
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="">
                                                    <FormLabel>Titulo Página (Inglés)</FormLabel>
                                                    <FormControl>
                                                        <Input
                                                            {...field}
                                                            type="text"
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="">
                                                    <FormLabel>Url Key (Inglés)</FormLabel>
                                                    <FormControl>
                                                        <Input
                                                            {...field}
                                                            type="text"
