...
function CustomerDialog() {
    ...
    const action = useCustomersStore(state => state.action);
    const selected = useCustomersStore(state => state.selected);
    const loading = useCustomersStore(state => state.loading);
    const isOpenDialog = useCustomersStore(state => state.isOpenDialog);
    const closeActionModal = useCustomersStore(state => state.closeActionModal);
