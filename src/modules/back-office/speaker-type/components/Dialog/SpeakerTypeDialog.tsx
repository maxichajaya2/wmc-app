...
function SpeakerTypesDialog() {

    const action = useSpeakerTypeStore(state => state.action);
    const selected = useSpeakerTypeStore(state => state.selected);
    const loading = useSpeakerTypeStore(state => state.loading);
    const isOpenDialog = useSpeakerTypeStore(state => state.isOpenDialog);
    const closeActionModal = useSpeakerTypeStore(state => state.closeActionModal);
    const create = useSpeakerTypeStore(state => state.create);
    const update = useSpeakerTypeStore(state => state.update);
    const remove = useSpeakerTypeStore(state => state.remove);

    const title = () => {
        switch (action) {
            case 'edit':
                return 'Editar Tipo de Conferencista'
            case 'delete':
                return 'Eliminar Tipo de Conferencista'
            case 'create':
                return 'Crear Tipo de Conferencista'
            default:
                return 'Tipo de Conferencista'
        }
    };
...
export default SpeakerTypesDialog