...
import SupplierFilters from "./components/Filter/SupplierFilters"
...
function CustomersPage() {
  ...
  const filtered = useSuppliersStore(state => state.filtered);
  const filterTerm = useSuppliersStore(state => state.filterTerm);

  const findAll = useSuppliersStore(state => state.findAll);
  const setFilterTerm = useSuppliersStore(state => state.setFilterTerm);
  const openActionModal = useSuppliersStore(state => state.openActionModal);
