...
import UnitFilter from "./components/Filter/UnitFilters"
...
function UnitsPage() {
  ...
  const filtered = useUnitsStore(state => state.filtered)
  const filterTerm = useUnitsStore(state => state.filterTerm)
  const setFilterTerm = useUnitsStore(state => state.setFilterTerm)
  const findAll = useUnitsStore(state => state.findAll)
