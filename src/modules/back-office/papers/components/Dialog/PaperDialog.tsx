            ...
            {(action === "create" ||
              ...
              <div className="space-y-6">
                  ...
                  render={(_) => (
                    <FormItem className="">
                      <FormLabel className="flex flex-col">
                        <p>
                          Adjuntar Paper <span className="text-red-500">*</span>
                        </p>
                        <span className="text-xs text-gray-500 mt-1">
                          Si encuentras algún problema al subir tu paper, por
                          favor contáctanos a wmc2026@iimp.org.pe para recibir
                          asistencia.
                        </span>
                        <span className="text-xs text-gray-500 mt-1">
                          (Solo se permiten archivos de Word (.doc y .docx))
                        </span>
                  ...
                  render={({ field }) => (
                    <FormItem className="">
                      <FormLabel>
                        ...
                        <span className="text-xs text-gray-500 mt-1">
                          (Por favor selecciona el tema que mejor se ajuste a tu
                          paper)
                        </span>
                      </FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="">
                      <FormLabel>Palabras claveX</FormLabel>
                      <FormControl>
                        <Creatable
                          isMulti
                          {...field}
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm mb-2 col-span-2">
                      <div className="space-y-0.5">
                        <FormLabel>
                          ¿El trabajo fue presentado en este evento o en otro
                          similar?
                        </FormLabel>
                        <FormDescription>
                          Si marca esta casilla, se le pedirá información
                          adicional.
                        </FormDescription>
                        <FormMessage />
                      </div>
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3 border rounded p-4">
                      <FormLabel className="text-sm leading-6">
                        <strong>
                          Por la presente declaro que tengo la debida
                          autorización para usar, reproducir, presentar y
                          exhibir el material incluido en mi envío, incluyendo,
                          pero no limitándose a, imágenes, representaciones,
                          videos, fotografías, gráficos y textos, estén o no los
                          derechos de autor formalmente registrados, y que
                          hacerlo no entra en conflicto ni infringe los derechos
                          de propiedad intelectual u otros derechos de ninguna
