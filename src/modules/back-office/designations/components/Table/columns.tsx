...
import { Category as Entity } from "@/models";
    ...
    return (
        <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent>
                ...
                {useCheckPermission(ModulesRoles.CATEGORIES, ActionRoles.UPDATE) && (
                    <DropdownMenuItem onClick={handleEdit}>Editar</DropdownMenuItem>
                )}
                {useCheckPermission(ModulesRoles.CATEGORIES, ActionRoles.DELETE) && (
