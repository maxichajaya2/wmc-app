...
function RoomsManagementPage() {
  ...
  const isOpenDialog = useRoomStore(state => state.isOpenDialog);
  const filtered = useRoomStore(state => state.filtered);
  const filterTerm = useRoomStore(state => state.filterTerm);

  const findAll = useRoomStore(state => state.findAll);
  const setFilterTerm = useRoomStore(state => state.setFilterTerm);
  const openActionModal = useRoomStore(state => state.openActionModal);
