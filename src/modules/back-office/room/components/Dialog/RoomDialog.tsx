...
function RoomsDialog() {
    ...
    const action = useRoomStore(state => state.action);
    ...
    const closeActionModal = useRoomStore(state => state.closeActionModal);
    const create = useRoomStore(state => state.create);
    const update = useRoomStore(state => state.update);
    const remove = useRoomStore(state => state.remove);
