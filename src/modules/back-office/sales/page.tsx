...
import SaleFilters from "./components/Filter/SaleFilters"
...
function SalesPage() {
  ...
  const filtered = useSalesStore(state => state.filtered);
  const filterTerm = useSalesStore(state => state.filterTerm);

  const findAll = useSalesStore(state => state.findAll);
  const setFilterTerm = useSalesStore(state => state.setFilterTerm);
