...
function PavilionsDialog() {

    const action = usePavilionStore(state => state.action);
    const selected = usePavilionStore(state => state.selected);
    const loading = usePavilionStore(state => state.loading);
    const isOpenDialog = usePavilionStore(state => state.isOpenDialog);
    const closeActionModal = usePavilionStore(state => state.closeActionModal);
    const create = usePavilionStore(state => state.create);
    const update = usePavilionStore(state => state.update);
    const remove = usePavilionStore(state => state.remove);

    const title = () => {
        switch (action) {
            case 'edit':
                return 'Editar Pabellón'
            case 'delete':
                return 'Eliminar Pabellón'
            case 'create':
                return 'Crear Pabellón'
            default:
                return 'Pabellón'
        }
    };
...
export default PavilionsDialog