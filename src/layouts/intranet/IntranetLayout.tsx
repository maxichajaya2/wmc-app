                                        ...
                                        {navItems.map((item) => (
                                            <Link
                                                ...
                                                className={cn(
                                                    ...
                                                    activeItem === item.id ? "bg-[#003540] text-white" : "text-gray-200",
                                                )}
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-56">
                                ...
                                <DropdownMenuItem asChild>
                                    <Link to={ROUTES_PATHS.PROFILE} className="flex cursor-pointer items-center">
                                        <User className="mr-2 h-4 w-4" />
                                        Perfil
                                    </Link>
                                </DropdownMenuItem>
                                <DropdownMenuSeparator />
                                <DropdownMenuItem onClick={handleLogout} className="flex cursor-pointer items-center text-[#c2082c]">
